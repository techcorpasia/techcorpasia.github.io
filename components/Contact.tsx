      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl p-8">
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <h4 className="text-xl font-bold text-secondary-900 mb-2">Message Sent Successfully!</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-primary-600 to-accent-600 text-white font-bold py-4 px-8 rounded-lg hover:from-primary-700 hover:to-accent-700 transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-2"
                  >
                    {isSubmitting ? (
                      <>
          ...
          >
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-secondary-900 mb-2">{info.title}</h4>
            ...
            >
              <h4 className="text-xl font-bold text-secondary-900 mb-4">Quick Actions</h4>
              <div className="space-y-4">
                <button className="w-full flex items-center justify-between p-4 bg-white rounded-lg hover:shadow-md transition-shadow duration-200">
                  <div className="flex items-center space-x-3">
                    <MessageSquare className="w-5 h-5 text-primary-600" />
                    <span className="font-medium text-secondary-900">Live Chat Support</span>
                  </div>
                ...
                <button className="w-full flex items-center justify-between p-4 bg-white rounded-lg hover:shadow-md transition-shadow duration-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-medium text-secondary-900">Schedule a Meeting</span>
                  </div>
                  <span className="text-sm text-secondary-600">Book online</span>
                </button>
              </div>
            </motion.div>
            ...
            >
              <h4 className="text-lg font-semibold text-secondary-900 mb-4">Follow Us</h4>
        ...
        >
          <div className="bg-secondary-100 rounded-2xl p-8 text-center">
            <h3 className="text-2xl font-bold text-secondary-900 mb-4">Our Global Presence</h3>
            <p className="text-secondary-600 mb-6">
              Serving clients worldwide with offices in key technology hubs
            </p>
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="h-64 bg-gradient-to-br from-secondary-200 to-secondary-300 rounded-lg flex items-center justify-center">
